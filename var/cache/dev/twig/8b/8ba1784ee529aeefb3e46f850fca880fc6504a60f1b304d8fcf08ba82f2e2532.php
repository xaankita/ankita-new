...
class __TwigTemplate_4cd4c08468935f480b07d354758b4d83dcbbb70759531474d41d2292685052b1 extends \Twig\Template
{
    private $source;
    private $macros = [];
...
<label<?php if (\$label_attr) { echo ' '.\$view['form']->block(\$form, 'attributes', ['attr' => \$label_attr]); } ?>><?php echo \$view->escape(false !== \$translation_domain ? \$view['translator']->trans(\$label, \$label_translation_parameters, \$translation_domain) : \$label) ?></label>
<?php endif ?>
", "@Framework/Form/form_label.html.php", "/Users/xearts/ankita/blog/vendor/symfony/framework-bundle/Resources/views/Form/form_label.html.php");
    }
}
